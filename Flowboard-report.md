...
| **Ventaja competitiva** | • Modelo de migración acelerada para registros físicos/virtuales. <br> • Elimina la dependencia de archivos aislados integrando asistencia y beneficios. <br> • Módulo de autogestión para resolución autónoma de dudas. | • Abarca todo el ciclo de vida del colaborador (encuestas, evaluaciones). <br> • Centraliza múltiples países en una sola plataforma (ideal multinacionales). | • Interfaz diseñada para fácil adopción en PYMES. <br> • Sistema de firma electrónica legalmente vinculante. <br> • Administración de ausencias y turnos en tiempo real. | • Motor de cálculo especializado en normativas laborales/tributarias locales. <br> • Infraestructura para procesamiento masivo de nómina. <br> • Alto nivel de seguridad en expedientes históricos. |
...
| **Fortalezas (SWOT)** | • Especializado en migración rápida de datos históricos. <br> • Módulo de autogestión reduce consultas a menos de 5 min. <br> • No requiere hardware. | • Diseño centrado en el colaborador y cubre todo su ciclo de vida. <br> • Presencia y soporte local consolidado en múltiples países. | • Interfaz moderna y de fácil adopción. <br> • Firma electrónica integrada. <br> • Precios modulares para PYMES. | • Motor de cálculo extremadamente preciso y potente. <br> • Actualización constante según normativa vigente. <br> • Herramientas avanzadas de auditoría. |
| **Debilidades (SWOT)** | • Startup en desarrollo sin una base de usuarios masiva aún. <br> • Recursos limitados frente a los gigantes del sector. | • Costos de implementación elevados para PYMES. <br> • Curva de aprendizaje moderada por la cantidad de módulos. | • Limitaciones en integraciones profundas con ERPs contables antiguos. <br> • Motor de nómina nativo menos robusto en algunos países (requiere integraciones). | • Interfaz abrumadora para usuarios que buscan algo simple. <br> • Implementación compleja que requiere consultoría. |
| **Oportunidades (SWOT)** | • Creciente transición de modelos tradicionales a digitales. <br> • Mayor adopción de Business Intelligence. <br> • Alianzas estratégicas con consultoras de transformación digital. | • Creciente demanda de upskilling online. <br> • Tendencia al alza en beneficios flexibles y bienestar financiero. | • Digitalización de PYMES para reemplazar procesos en papel. <br> • Uso de IA en procesos de selección (ATS). | • Empresas con software obsoleto buscando migrar a la nube. <br> • Alianzas estratégicas con firmas de auditoría y contabilidad. |
| **Amenazas (SWOT)** | • Ingreso de competidores con mayor capital y funciones similares. <br> • Resistencia al cambio organizacional en empresas convencionales. | • Competencia de software globales con mayores presupuestos (I+D). <br> • Saturación del mercado corporativo en la región. | • Startups locales que ofrecen cumplimiento legal específico a menor costo. <br> • Cambios constantes en normativas laborales. | • Nuevos competidores con interfaces más modernas que simplifiquen el cumplimiento legal. |
...
Edad: 22
Distrito: Chorrillos
Link de la entrevista: https://upcedupe-my.sharepoint.com/:v:/g/personal/u202412270_upc_edu_pe/IQDeY0NXAzPjQJejaGqcrA1dAcBAk6beDMfPNVNjCKiaUU0?nav=eyJyZWZlcnJhbEluZm8iOnsicmVmZXJyYWxBcHAiOiJPbmVEcml2ZUZvckJ1c2luZXNzIiwicmVmZXJyYWxBcHBQbGF0Zm9ybSI6IldlYiIsInJlZmVycmFsTW9kZSI6InZpZXciLCJyZWZlcnJhbFZpZXciOiJNeUZpbGVzTGlua0NvcHkifX0&e=A1Y5zL
Timing donde inicia la entrevista: 00:00
Duración completa de la entrevista: 08:22
**Resumen de la entrevista:**
Jimena, de 22 años, soltera, residente en Chorrillos y asistente en el área de Recursos Humanos, percibió desde el primer momento que FlowBoard es una plataforma integral orientada a centralizar la gestión de recursos humanos, permitiendo administrar colaboradores, solicitudes, asistencias y nóminas en un solo lugar. Consideró que la propuesta de valor y las soluciones ofrecidas por el sistema son claras a primera vista, destacando que la landing page transmite una imagen moderna, profesional, corporativa y confiable. Asimismo, señaló que los términos utilizados son comprensibles para cualquier persona relacionada con recursos humanos y que la estructura de la página sigue una secuencia lógica que facilita la navegación y el entendimiento de las funcionalidades. Durante la evaluación del prototipo, identificó rápidamente las solicitudes pendientes gracias a la claridad de los estados mostrados y destacó que la organización por módulos facilita el acceso a información específica como asistencias, gestión de personal y pagos. Consideró que la distribución del menú es coherente con los procesos habituales de administración de personal y que los textos, colores y contrastes permiten una lectura cómoda sin generar fatiga visual. También indicó que la interfaz es intuitiva y amigable, por lo que incluso usuarios con poca experiencia tecnológica podrían aprender a utilizarla rápidamente. En cuanto a accesibilidad, opinó que el sistema es adecuado en términos generales, aunque recomendó incorporar opciones adicionales como aumento de tamaño de fuente y ajustes de contraste para usuarios con dificultades visuales. Además, resaltó que la plataforma podría generar un importante ahorro de tiempo operativo al centralizar procesos y evitar la dispersión de información en múltiples herramientas, manteniendo una interfaz limpia que no abruma pese a manejar datos de numerosos colaboradores. Como sugerencia de mejora, propuso añadir filtros más visibles y rápidos para localizar información específica de colaboradores en situaciones urgentes. Finalmente, afirmó que se sintió segura al interactuar con información sensible dentro del sistema, valoró especialmente la organización de las funcionalidades y la facilidad de navegación, y señaló que recomendaría implementar FlowBoard en su lugar de trabajo debido a su capacidad para optimizar procesos administrativos, centralizar información y mejorar la eficiencia operativa del área de Recursos Humanos.
...
Distrito: Lambayeque
Link de la entrevista: https://upcedupe-my.sharepoint.com/:v:/g/personal/u202412270_upc_edu_pe/IQDeY0NXAzPjQJejaGqcrA1dAcBAk6beDMfPNVNjCKiaUU0?nav=eyJyZWZlcnJhbEluZm8iOnsicmVmZXJyYWxBcHAiOiJPbmVEcml2ZUZvckJ1c2luZXNzIiwicmVmZXJyYWxBcHBQbGF0Zm9ybSI6IldlYiIsInJlZmVycmFsTW9kZSI6InZpZXciLCJyZWZlcnJhbFZpZXciOiJNeUZpbGVzTGlua0NvcHkifX0&e=A1Y5zL
Timing donde inicia la entrevista: 08:22
Duración completa de la entrevista: 07:24
**Resumen de la entrevista:**
Sergio Fuentes, de 24 años, soltero y residente en Lambayeque, se desempeña como analista de talento humano y explicó que actualmente el control de asistencia de los colaboradores se realiza mediante una plantilla donde se registran asistencias, tardanzas y faltas, aplicando los descuentos correspondientes según la justificación de cada caso. Durante la evaluación de la landing page de FlowBoard, comprendió rápidamente que se trataba de una plataforma integral para la gestión de recursos humanos, identificando con facilidad funcionalidades relacionadas con asistencia, pagos, solicitudes e información laboral. Destacó que el diseño le pareció corporativo, ordenado y de fácil acceso, señalando que la distribución de las secciones era lógica y que la información resultaba clara desde el primer vistazo. Al interactuar con el prototipo, valoró especialmente la organización del dashboard, la facilidad para identificar solicitudes pendientes, gestionar aprobaciones o rechazos, revisar asistencias y acceder a la información de pagos de los colaboradores. Consideró que los filtros disponibles facilitan la búsqueda de información específica y que la navegación es intuitiva, permitiendo que incluso personas con poca experiencia tecnológica puedan utilizar la plataforma sin dificultades. Asimismo, indicó que los textos, botones e íconos son comprensibles y que la interfaz mantiene una presentación limpia sin resultar abrumadora pese a manejar información de múltiples colaboradores. Entre las funcionalidades más útiles para su labor destacó el módulo de asistencia y el control de pagos, ya que contribuyen a optimizar tareas operativas diarias. Finalmente, manifestó sentirse cómodo con la estructura general del sistema y afirmó que recomendaría su implementación en su lugar de trabajo, siempre que se garantice la seguridad y confiabilidad de los datos, debido a que considera que la plataforma puede mejorar significativamente la eficiencia de los procesos de gestión de personal.

**Segmento 2: Colaboradores generales**
Entrevista:
Nombre: María del Carmen Espichan
Edad: 24
Distrito:  AT, Salamanca
Link de la entrevista: https://upcedupe-my.sharepoint.com/:v:/g/personal/u202412270_upc_edu_pe/IQDeY0NXAzPjQJejaGqcrA1dAcBAk6beDMfPNVNjCKiaUU0?nav=eyJyZWZlcnJhbEluZm8iOnsicmVmZXJyYWxBcHAiOiJPbmVEcml2ZUZvckJ1c2luZXNzIiwicmVmZXJyYWxBcHBQbGF0Zm9ybSI6IldlYiIsInJlZmVycmFsTW9kZSI6InZpZXciLCJyZWZlcnJhbFZpZXciOiJNeUZpbGVzTGlua0NvcHkifX0&e=A1Y5zL
Timing donde inicia la entrevista: 15:47
Duración completa de la entrevista: 14:03
**Resumen de la entrevista:**
María del Carmen Espichan, asistente legal, comentó que actualmente la gestión de vacaciones y permisos en su empresa se realiza mediante un enlace corporativo que envía las solicitudes a los jefes para su aprobación, mientras que las boletas de pago se consultan a través de un portal interno, aunque no todos los colaboradores tienen acceso a estas herramientas. Señaló que una de sus principales frustraciones es la limitada interacción que ofrecen los sistemas actuales, ya que solo permiten visualizar información y obligan a realizar consultas o actualizaciones de datos personales mediante correos electrónicos u otros canales externos. Respecto a FlowBoard, identificó rápidamente que la plataforma está orientada a la gestión de recursos humanos y destacó especialmente los módulos de asistencia, solicitudes, pagos e información laboral, valorando la presencia de dashboards y gráficos para el seguimiento de indicadores. Consideró que la distribución de las secciones es lógica, intuitiva y fácil de comprender incluso para usuarios con poca experiencia tecnológica, por lo que podría utilizarse sin necesidad de un manual. Además, resaltó que la plataforma podría mejorar la cercanía entre colaboradores y Recursos Humanos al centralizar procesos y permitir una gestión más eficiente de la información. Como sugerencias de mejora, recomendó implementar la carga masiva de colaboradores, ampliar el detalle mostrado en las boletas de pago (incluyendo montos brutos, descuentos y montos netos) y simplificar la visualización de algunos datos numéricos. En términos generales, manifestó una percepción positiva sobre el diseño, la navegación y la utilidad del sistema, indicando que recomendaría su implementación en su centro de trabajo debido a su potencial para modernizar procesos, centralizar la información y reducir el uso de herramientas manuales como hojas de cálculo y comunicaciones dispersas.
